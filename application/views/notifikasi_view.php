                                ...
                                <div class="box-body table-responsive no-padding">
                                    <table class="table">
                                        ...
                                        <tr style="background:<?=$key->NOTIF_READ == 0 ? "#f5f5f5" : "none"; ?>">
                                            ...
                                            <td><button class="btn btn-xs btn-flat <?=$key->NOTIF_READ == 0 ? "btn-primary" : "btn-default disabled"; ?>" onclick="modalbacasatu('<?=$key->NOTIF_ID?>', '<?=addslashes($key->NOTIF_TIME)?>', '<?=addslashes($key->user_name)?>')"><i class="fa fa-check"></i> Baca</button></td>
                                        </tr>
                                        <?php } } else {  ?>
                                        <tr>
